...
<div class="form-group">
    ...
    <input type="text" class="form-control" id="b_name" name="fullname" placeholder="Full Name" value="Mariusz Marciniak">
</div>
<div class="form-group">
    <div class="form-row">
        <div class="col-6">
        <input type="email" class="form-control" id="b_email" aria-describedby="emailHelp" placeholder="Email address" name="email" value="waghtot@gmail.com">
        </div>
        <div class="col-6">
        <input type="text" class="form-control postcode" id="b_phone" name="phone" placeholder="Phone Number" value="07713926072">
        </div>
    </div>
</div>
<div class="form-group">
    <div class="form-row">
        ...
        <div class="col-4">
            ...
            <input type="text" class="form-control postcode" id="b_post" name="postcode" placeholder="PostCode" value="W12">
        </div>
    </div>
</div>
