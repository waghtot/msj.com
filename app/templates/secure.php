...
<!-- <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.8/dist/js/bootstrap.bundle.min.js" integrity="sha384-FKyoEForCGlyvwx9Hj09JcYn3nv7wiPVlz7YYwJrWVcXK/BmnVDxM+D2scQbITxI" crossorigin="anonymous"></script> -->
    <link rel="stylesheet" type="text/css" href="app/views/css/msj.css?v=<?php echo time(); ?>">
        ...
        foreach($data->getBody() as $value){
            switch($value['Type']){
                ...
                case 2:
                    ...
                    break; 
                case 3:
                    require_once "app/controllers/SetGallery.php";
                    $gallery = new Set_Gallery($value);
                    $value = $gallery->getGallery();
                    View::partial('gallery', $value);
                break;
                case 4:
